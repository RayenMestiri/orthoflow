...
import { communicationRoutes } from './communications/communication.routes.js';
...
export const registerModules: FastifyPluginAsyncZod = async (app) => {
  ...
  await app.register(portalRoutes, { prefix: `${API_PREFIX}/portal` });
  await app.register(portalManagementRoutes, { prefix: `${API_PREFIX}/portal-management` });
  ...
  await app.register(communicationRoutes, { prefix: `${API_PREFIX}/communications` });
};
