...
export const PATIENT_ACTIVITY_TYPES = {
  ...
  RETENTION_ACTIVATED: 'RETENTION_ACTIVATED',
  RETENTION_COMPLETED: 'RETENTION_COMPLETED',
  RETENTION_CANCELLED: 'RETENTION_CANCELLED',
  RETAINER_DELIVERED: 'RETAINER_DELIVERED',
  RETAINER_REPLACED: 'RETAINER_REPLACED',
  RETAINER_LOST: 'RETAINER_LOST',
  RETAINER_DISCONTINUED: 'RETAINER_DISCONTINUED',
  ...
  GENERATED_DOCUMENT_EXPIRED: 'GENERATED_DOCUMENT_EXPIRED',
} as const;
